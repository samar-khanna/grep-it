...
so_code_tokenizer = Tokenizer.from_file('./data/so_rust_combined/code_tokenizer.json')
...
so_lang_tokenizer = Tokenizer.from_file('./data/so_rust_combined/lang_tokenizer.json')
...
so_model = fasttext.load_model('./data/so_rust_combined/so_skipgram.bin')
so_vecs = np.load('./data/so_rust_combined/embedding.npy')
